  ...
  return (
    ...
    >
      ...
      <div className="hero-content">
        ...
        >
          WashWala is a doorstep laundry service built like a delivery app —
          think Zomato, but for your dirty clothes. Schedule a pickup, choose
          your wash type, and get{" "}
          <strong>fresh, clean clothes delivered back</strong> to you. Per-item
          pricing, transparent billing, live tracking — all in one app.
        </p>
          ...
          <a
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 10px 32px rgba(42,157,143,0.4)";
              e.currentTarget.style.background = "var(--teal-light)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow =
                "0 6px 24px rgba(42,157,143,0.3)";
      ...
      >
        <Image
          ...
          style={{
            borderRadius: "40px",
            boxShadow:
              "0 40px 100px rgba(26,26,46,0.18), 0 0 0 8px rgba(42,157,143,0.08)",
